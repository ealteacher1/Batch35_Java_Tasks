...
public class Exception_Handling_finally {
		...
		public static void main(String[] args) {
			...
			//Finally concept:, if code is int v= 6/2, JVM will not print that as there is no exception, it'll skip catch block  and print 'finally' block 
			
			}finally {
				
			}
			System.out.println("This is finally");//no matter what, Codes written in finally block  will be executed .
