...
public class Suzy_task1 {
	...
	public static void main(String[] args) {
	    ...
	    ob.home(new Suzy_task1());   //calling by value 
	     ...
	     ob2.kids(new Suzy_task1()) ;   //calling by value
	     
	     
	     Suzy_task1 ob3 = new  Suzy_task1 ();
	     ob3.boy (ob3);   //calling by variable 
	     ob3 .boy ( new Suzy_task1 ());   //calling by value
	     
	     
	     Suzy_task1 ob4 = new Suzy_task1 ();
	     ob4.girl(ob4);   //calling by variable 
	     ob4.girl(new Suzy_task1());   //calling by value
	     
	
	
  
//	create 5 examples by calling by object reference /class variable --
