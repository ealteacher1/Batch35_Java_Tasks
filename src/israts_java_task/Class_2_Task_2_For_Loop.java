...
public class Class_2_Task_2_For_Loop {
...
// Task-
        ...
        // print 3 to 20;
        for (int b = 3; b<=20; b++) {
        System.out.println("Laugh "+b);

        }

        // print -355 to -255;
        for (int c = -355; c<=-255; c++) {
            System.out.println("Cry "+c);

        }
      //print -956 to -960
        for (int d =-956; d>=-960; d--) {
            System.out.println("Giggle"+d);

        }
        // print -10 to 10;
        for(int e =-10; e<=10; e++) {
            System.out.println("Race "+e);
        }
